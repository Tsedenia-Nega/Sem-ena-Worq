...
router.post("/create",Middlware.authMiddleware, upload.single('image'), (req, res) => portfolioController.createPortfolio(req, res));


router.put("/update/:id", Middlware.authMiddleware, upload.single('image'), (req, res) => portfolioController.updatePortfolio(req, res));

router.delete("/delete/:id", Middlware.authMiddleware, (req, res) => portfolioController.deletePortfolio(req, res));
